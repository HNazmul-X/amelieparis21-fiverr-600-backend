        ...
        return new Promise(async (resolve, reject) => {
            ...
            ">
                ...
                ">
                    ...
                    <div style="display: flex; margin:auto; margin-top: 8px;">
                        <a href="" style="text-decoration: none">
                            <img src="https://i.ibb.co/9TdT0z9/et-linkedin.png" alt="" /></a>
                        <a href="" style="text-decoration: none; margin: 0 20px">
                            <img src="https://i.ibb.co/dfj95w7/Group-1.png" alt="" /></a>
                        <a href="" style="text-decoration: none">
                            <img src="https://i.ibb.co/Q99d4pK/la-discord.png" alt="" /></a>
                    </div>
                </div>
            ...
            const verification_template = `
                        <div style="margin:0 auto;max-width:800px;padding:0;background-color:#f7faff">
                            <div style="background-color:#f7faff;padding-bottom:30px;font-family:Verdana,Geneva,Tahoma,sans-serif">
                                <div style="background-color:#447ef2;display:flex;padding:10px 0 15px;flex-direction: column;align-content: center;align-items: center;">
                                    <div>
                                        <h1 style="color:#fff;padding:0 10px;text-align:center;font-size:10vmin;margin:0">
                                            One Card Pro
                                        </h1>
                                    </div>
                                    <div style="display:flex;margin-top:8px">
                                        <a style="text-decoration:none">
                                            <img src="https://i.ibb.co/9TdT0z9/et-linkedin.png" alt="" class="CToWUd"></a>
                                        <a style="text-decoration:none;margin:0 20px">
                                            <img src="#https://i.ibb.co/dfj95w7/Group-1.png" alt="" class="CToWUd"></a>
                                        <a style="text-decoration:none">
                                            <img src="https://i.ibb.co/Q99d4pK/la-discord.png" alt="" class="CToWUd"></a>
                                    </div>
                                </div>
                                <div style="text-align:center;margin-top:40px;margin-bottom:40px">
                                    ...
                                    <h2 style="color:#57697d;font-size:70px;padding:0 10px;margin:15px auto;font-family:jetbrains mono,consolas,firacode,monospace;background:#c4c9cf;width:max-content">
                                        ${code}
                                    </h2>
